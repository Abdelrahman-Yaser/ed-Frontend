    ...
    <>
      ...
      <div className="container mx-auto mt-10 px-4">
        <div className="bg-white p-8 rounded-lg shadow max-w-2xl mx-auto">
          <h1 className="text-center text-3xl font-bold mb-6 text-gray-800">Edit Material</h1>
          <form>
            {/* Material Name */}
            <div className="mb-6">
              ...
              <input
                type="text"
                id="materialName"
                defaultValue="Current Material Name"
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={5}
                defaultValue="Current material description goes here..."
                className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              ></textarea>
            </div>
